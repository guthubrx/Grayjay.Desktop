# Tasks: Smart Chapters Queue

- [x] T001 Replace the in-memory queues with a persisted ordered queue.
- [x] T002 Add queue position, source, video metadata, promote, and remove contracts.
